...
export const CandleChart = ({ symbol }) => {
...
useEffect(() => {
  ...
  seriesRef.current =
    chartInstance.current.addSeries(CandlestickSeries);
...
backdrop-blur-md">
      ...
      {!isLoading && !error && <div ref={chartRef} />}


      {/* Loading */}
      {isLoading && (
        <p className="text-gray-400 mb-2">Loading chart...</p>
      )}
